...
import com.iso.multistream.databinding.ListItemTwoBinding
...
class PlaceHolderAdapter<T, K : ViewDataBinding>(
    ...
    class MyViewHolder<K : ViewDataBinding>(val dataBinding: K, onShowPressAnimation: Boolean) :
        ...
        init {
            when (binding) {
                is com.iso.multistream.databinding.ListItemTwoBindingImpl -> (binding as ListItemTwoBinding).streamerBanner.setOnClickListener {
                    placeHolderListener?.onCircleClick(
                        adapterPosition,
                        it
                    )
                }
                is com.iso.multistream.databinding.ListItemTwoExtendedBindingImpl -> (binding as ListItemTwoExtendedBinding).streamerBanner.setOnClickListener {
                    placeHolderListener?.onCircleClick(
                        adapterPosition,
                        it
                    )

...
import com.iso.multistream.auth.platforms.MixerPlatform
import com.iso.multistream.auth.platforms.TwitchPlatform
import com.iso.multistream.ui.main_activity.fragments.settings_fragment.SettingsLoader
import com.iso.multistream.utils.WorkFactory
...
//        platformManager.addPlatform(mixerPlatform)
    ...
    override fun applicationInjector(): AndroidInjector<out DaggerApplication> {
        return com.iso.multistream.di.DaggerAppComponent.builder().application(this).build()
    }

...
class MixerChannelsList @Inject constructor() :
    RecyclerView.Adapter<MixerChannelsList.MyViewHolder>() {
    ...
    class MyViewHolder(val binding: MixerChannelsListBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding =
            MixerChannelsListBinding.inflate(LayoutInflater.from(parent.context), parent, false)

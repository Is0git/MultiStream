...
class AnimationHandler(val rootView: ScrollView) {
    ...
    fun animate(
        ...
        animView.apply {
            ...
            val value = when {
                relativeCoordinate < animation.topDivider && relativeCoordinate > 0 -> animation.onScrollTop(this, relativeCoordinate, t, oldt)

                relativeCoordinate < rootView.height - animation.bottomDivider && relativeCoordinate > animation.topDivider ->  animation.onScrollMiddle(this, relativeCoordinate, t, oldt)


                relativeCoordinate > rootView.height -  animation.bottomDivider && relativeCoordinate < rootView.height -> animation.onScrollBottom(this, relativeCoordinate, t, oldt)
